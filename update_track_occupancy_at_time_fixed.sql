-- Update the get_track_occupancy_at_time function to be compatible with
-- our changes to exclude 'initial' move_type in get_track_wagons_at_time
...
BEGIN
  ...
  BEGIN
    ...
    BEGIN
      ...
      -- Use the get_track_wagons_at_time function to get wagons
      -- which now properly excludes 'initial' move_type
