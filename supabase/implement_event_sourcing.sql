...
VALUES ('UPDATE', 'system', NULL, 'Implementing event-sourcing architecture foundation');
...
INSERT INTO audit_logs (action, table_name, record_id, details)
VALUES ('UPDATE', 'system', NULL, 'Event-sourcing foundation implemented');
