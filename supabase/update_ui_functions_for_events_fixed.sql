-- update_ui_functions_for_events_fixed.sql
...
VALUES ('UPDATE', 'system', NULL, '{"message": "Updating UI functions to use event-sourcing approach"}');
...
BEGIN
    ...
    VALUES ('DEBUG', 'functions', NULL, 
            json_build_object('message', 'Called get_track_wagons_at_time', 
...
EXCEPTION WHEN OTHERS THEN
    ...
    VALUES ('ERROR', 'functions', NULL, 
            json_build_object('message', 'Error in get_track_wagons_at_time', 'error', SQLERRM));
...
INSERT INTO audit_logs (action, table_name, record_id, details)
VALUES ('UPDATE', 'system', NULL, '{"message": "UI functions updated to use event-sourcing approach"}');
