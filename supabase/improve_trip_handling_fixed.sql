-- improve_trip_handling_fixed.sql
...
VALUES ('UPDATE', 'system', NULL, '{"message": "Improving trip handling for event-sourcing"}');
...
BEGIN
    ...
    LOOP
        ...
        IF trip_data.dest_track_id <> current_track_id THEN
            ...
            VALUES (
                ...
                'wagon_trajectories', 
                wagon_id::TEXT,
                json_build_object('message', 'Created trajectory for internal trip', 'trip_id', trip_id)
            );
        END IF;
    ...
    INSERT INTO audit_logs (action, table_name, record_id, details)
    VALUES ('INSERT', 'trips', trip_id::TEXT, '{"message": "Created internal trip"}');
...
EXCEPTION WHEN OTHERS THEN
    ...
    VALUES ('ERROR', 'trips', COALESCE(trip_id::TEXT, 'NULL'), 
            json_build_object('message', 'Error creating internal trip', 'error', SQLERRM));
...
INSERT INTO audit_logs (action, table_name, record_id, details)
VALUES ('UPDATE', 'system', NULL, '{"message": "Trip handling improved for event-sourcing"}');
